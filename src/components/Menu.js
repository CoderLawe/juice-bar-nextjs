...
const Menu = () => {
    return(
        ...
        >
            {/* First slide */}
        <section className="bg-smallMenuBackground lg:bg-none  bg-cover bg-fixed lg:flex block mx-auto justify-between lg:mx-12 pb-32 mt-16">
                {/* Left side */}
                    <div className="bg-black/70 flex-col space-y-10 z-20 px-2 lg:mx-0">
                ...
                <div className="flex-col bg-black/70 space-y-10 z-20  pt-6 px-2 lg:mx-0">
